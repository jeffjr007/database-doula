            ...
            <AnimatePresence mode="wait">
              ...
              {showDiagnostic && (
                ...
                >
                  ...
                  >
                    <Card className="p-6 bg-gradient-to-r from-primary/10 to-[#0077B5]/10 border-primary/30">
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-muted-foreground">
                            Revise seu diagnóstico e depois siga para a Etapa 2 - CV Personalizado.
                          </p>
                        </div>
                      </div>
                      <Button
